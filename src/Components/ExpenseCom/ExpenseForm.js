...
const ExpenseForm = ({route}) => {
  ...
  useEffect(() => {
    if (item) {
      setForm({
        ...
        ex_in_type: item.ex_in_type || 'Expense',
  ...
  const validateForm = () => {
    ...
    if (form.in_ex_description.trim().length ==0) {
      err.in_ex_description = 'Fill the description';
    }
          ...
          <View style={styles.form}>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.typeRow}>
                <TouchableOpacity
                  style={[
                    styles.typeBtn,
                    form.ex_in_type === 'Income' && styles.typeBtnActive,
                  ]}
                  onPress={() => handleChange('ex_in_type', 'Income')}>
                  <Text
                    style={[
                      styles.typeText,
                      form.ex_in_type === 'Income' && {color: '#fff'},
                    ]}>
                    Income
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={[
                    styles.typeBtn,
                    form.ex_in_type === 'Expense' && styles.typeBtnActive,
                  ]}
                  onPress={() => handleChange('ex_in_type', 'Expense')}>
                  <Text
                    style={[
                      styles.typeText,
                      form.ex_in_type === 'Expense' && {color: '#fff'},
                    ]}>
                    Expense
                  </Text>
                </TouchableOpacity>
            ...
            <View style={styles.inputGroup}>
              ...
              <Dropdown
                style={[
                  styles.dropdown,
                  errors.category && {borderColor: 'red'},
                ]}
                placeholderStyle={styles.placeholderStyle}
                selectedTextStyle={styles.selectedTextStyle}
                itemTextStyle={{color: '#000', marginVertical: -12}}

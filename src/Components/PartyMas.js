      ...
      <TouchableOpacity
        ...
        <View style={styles.actions}>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              Linking.openURL(`https://wa.me/91${item.party_mobile}`)
            }>
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={[styles.headerTitle, {paddingLeft: 30}]}>Party</Text>
      ...
      {/* Search Bar */}
      <View style={[styles.searchContainer, {marginLeft: 12}]}>
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          setSelectedItem(null);
          navigation.navigate('PartyAddScreen');
        }}
        activeOpacity={0.8}>
        ...
        <Pressable
          ...
          <Pressable
            ...
            <View
              ...
              <TouchableOpacity
                onPress={() => {
                  confirmDelete(selectedItem?.party_id);
